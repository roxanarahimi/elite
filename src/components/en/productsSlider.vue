        ...
        <slide v-for="(item,index) in data2" :key="index">
          <div class="w-100 h-100" style="margin: 1px">
            <div class="w-100 h-100">
              <router-link :to="'/en/product/'+item.id" class="bg-gray3" style=" border-radius: 30px;overflow: hidden;">
        ...
        <slide v-for="(item,index) in data" :key="index">
          <div class="w-100 h-100" style="margin: 1px">
            <div class="w-100 h-50" style="margin: 1px">
              ...
              <router-link :to="'/en/product/'+item[0].id" class="bg-gray3" style=" border-radius: 30px;overflow: hidden;">
                <div class="slideContainer" style="position: relative;">
            ...
            <div v-if="item[1].length != 0" class="w-100 h-50" style="margin: 1px">
              ...
              <router-link :to="'/en/product/'+item[1].id" class="bg-gray3" style="  border-radius: 30px;overflow: hidden;">
                <div class="slideContainer " style="position: relative;">
